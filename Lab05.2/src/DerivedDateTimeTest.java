...
class DerivedDateTimeTest {
  ...
  /**
   * TASK: new American presidents are often measured by their performance during the first 100 days
   * in office. Inauguration Day 2017 is Jan 20.  When is this president's 100-day deadline?
   * <p>
   * RESULT:
   */
  ...
  /**
   * TASK: Certain times of the year seem to have more birthdays than other times. Some believe that
   * this is because more babies are conceived during certain times of year. Below, assume a due
   * date 38 weeks after conception, during a non-leap-year.
   * <p>
   * RESULT:
   */
  ...
  /**
   * TASK: you've saved diligently your whole life and plan to retire as soon as you can take
   * distributions from your 401(k) penalty-free, which is when you turn 59 1/2. When will / did you
   * retire?
   * <p>
   * RESULT:
   */
  public static void testEarlyRetirement() {
    // TODO
    LocalDate birthday = LocalDate.of(1985, 02, 18);
    LocalDate retirement = birthday.plusYears(59).plusMonths(6);
    System.out.println(retirement);
  }

  /**
   * TASK: when was Labor Day during the year you were born? Note: start with a LocalDate equal to
   * your birthday. Note: Labor Day is the first Monday in Sept.
   * <p>
   * RESULT:
   */
  ...
  /**
   * TASK: Election Day in the United States is defined as the Tuesday immediately after the 1st
   * Monday in November. When is Election Day 2024?
   * <p>
   * RESULT:
   */
  ...
  /**
   * TASK: Akesh and Samanta were married on 6/6/1969. They are planning their 50th wedding
   * anniversary, and would like to throw a big party. If their anniversary does not fall on a
   * Saturday, they'd like to have their party the following Saturday. What is the date of the
   * party?
   * <p>
   * RESULT:
   */
